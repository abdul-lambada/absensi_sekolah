...
abstract class IOFactory
{
     ...
     *                                 IOFactory::READER_*.
     */
    public static function load($filename, $flags = 0, $readers = null)
    {
     ...
     *                                 IOFactory::READER_*.
     */
    public static function createReaderForFile($filename, $readers = null)
    {
        ...
        if ($readers !== null) {
            ...
            $testReaders = array_filter(
                self::$readers,
                function ($readerType) use ($readers) {
